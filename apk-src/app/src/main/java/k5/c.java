...
public abstract class c {
    ...
    public static final byte[] f26902a;

    static {
        String str = z.f28608a;
        f26902a = "OpusHead".getBytes(StandardCharsets.UTF_8);
    }

    public static void a(m3.p pVar) {
        int i = pVar.f28590b;
        pVar.N(4);
        if (pVar.m() != 1751411826) {
            i += 4;
        }
        pVar.M(i);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:373:0x06da  */
    /* JADX WARN: Removed duplicated region for block: B:388:0x071f  */
    /* JADX WARN: Removed duplicated region for block: B:38:0x009d  */
    /* JADX WARN: Removed duplicated region for block: B:419:0x0784  */
    /* JADX WARN: Removed duplicated region for block: B:443:0x07cc  */
    /* JADX WARN: Removed duplicated region for block: B:618:0x0813 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:95:0x0176  */
    /* JADX WARN: Type update failed for variable: r7v20 java.util.List, new type: ad.b1
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 32021. Try increasing type updates limit count.
    	...
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.updateTypeForSsaVar(TypeUpdate.java:197)
     */
    /* JADX WARN: Type update failed for variable: r7v9 java.util.List, new type: ad.b1
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 32021. Try increasing type updates limit count.
    	at jadx.core.dex.visitors.typeinference.TypeUpdateInfo.requestUpdate(TypeUpdateInfo.java:37)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.requestUpdate(TypeUpdate.java:224)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.updateTypeForSsaVar(TypeUpdate.java:202)
    ...
    */
    public static void b(m3.p r49, int r50, int r51, int r52, int r53, java.lang.String r54, boolean r55, j3.l r56, com.google.android.gms.internal.ads.q5 r57, int r58) throws j3.d0 {
        /*
            Method dump skipped, instruction units count: 3202
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: k5.c.b(m3.p, int, int, int, int, java.lang.String, boolean, j3.l, com.google.android.gms.internal.ads.q5, int):void");
    }

    public static m5 c(int i, m3.p pVar) {
        pVar.M(i + 12);
        pVar.N(1);
        d(pVar);
        pVar.N(2);
        ...
        return new m5(strE, bArr, j10, jB > 0 ? jB : -1L);
    }

    public static int d(m3.p pVar) {
        int iZ = pVar.z();
        int i = iZ & 127;
        while ((iZ & 128) == 128) {
            iZ = pVar.z();
    ...
    public static b0 f(n3.c cVar) {
        n3.a aVar;
        n3.d dVarS = cVar.s(1751411826);
        n3.d dVarS2 = cVar.s(1801812339);
        n3.d dVarS3 = cVar.s(1768715124);
        if (dVarS != null && dVarS2 != null && dVarS3 != null) {
            m3.p pVar = dVarS.f29043d;
            pVar.M(16);
            if (pVar.m() == 1835299937) {
                m3.p pVar2 = dVarS2.f29043d;
                pVar2.M(12);
                int iM = pVar2.m();
                ...
                for (int i = 0; i < iM; i++) {
                    int iM2 = pVar2.m();
                    pVar2.N(4);
                    strArr[i] = pVar2.x(iM2 - 8, StandardCharsets.UTF_8);
                }
                m3.p pVar3 = dVarS3.f29043d;
                pVar3.M(8);
                ArrayList arrayList = new ArrayList();
                while (pVar3.a() > 8) {
                    int i10 = pVar3.f28590b;
                    int iM3 = pVar3.m();
                    int iM4 = pVar3.m() - 1;
                    if (iM4 < 0 || iM4 >= iM) {
                        gf.a.p(iM4, "Skipped metadata with unknown key index: ", "BoxParsers");
                    } else {
                        String str = strArr[iM4];
                        int i11 = i10 + iM3;
                        while (true) {
                            int i12 = pVar3.f28590b;
                            if (i12 >= i11) {
                                aVar = null;
                                break;
                            }
                            int iM5 = pVar3.m();
                            if (pVar3.m() == 1684108385) {
                                int iM6 = pVar3.m();
                                int iM7 = pVar3.m();
                                int i13 = iM5 - 16;
                                byte[] bArr = new byte[i13];
                                pVar3.k(bArr, 0, i13);
                                aVar = new n3.a(iM7, iM6, str, bArr);
                                break;
                            }
                            pVar3.M(i12 + iM5);
                        }
    ...
    public static n3.f g(m3.p pVar) {
        long jT;
        long jT2;
        pVar.M(8);
        if (e(pVar.m()) == 0) {
        ...
        return new n3.f(jT, jT2, pVar.B());
    }

    public static Pair h(m3.p pVar, int i, int i10) throws d0 {
        Integer num;
        r rVar;
        Pair pairCreate;
        int i11;
        ...
        while (i13 - i < i10) {
            pVar.M(i13);
            int iM = pVar.m();
            q4.b.e("childAtomSize must be positive", iM > 0);
            if (pVar.m() == 1936289382) {
                int i14 = i13 + 8;
                int i15 = 0;
                int i16 = -1;
                ...
                while (i14 - i13 < iM) {
                    ...
                    int iM3 = pVar.m();
                    if (iM3 == 1718775137) {
                        numValueOf = Integer.valueOf(pVar.m());
                    } else if (iM3 == 1935894637) {
                        pVar.N(4);
                        strX = pVar.x(4, StandardCharsets.UTF_8);
                ...
                if ("cenc".equals(strX) || "cbc1".equals(strX) || "cens".equals(strX) || "cbcs".equals(strX)) {
                    q4.b.e("frma atom is mandatory", numValueOf != null);
                    q4.b.e("schi atom is mandatory", i16 != -1);
                    int i17 = i16 + 8;
                    while (true) {
                        if (i17 - i16 >= i15) {
                            num = numValueOf;
                        ...
                        if (pVar.m() == 1952804451) {
                            ...
                            num = num2;
                            rVar = new r(z5, strX, iZ2, bArr2, i12, i11, bArr);
                        } else {
                            i17 += iM4;
                        }
                    }
                    q4.b.e("tenc atom is mandatory", rVar != null);
                    String str = z.f28608a;
    ...
    /* JADX WARN: Removed duplicated region for block: B:372:0x07f0  */
    /* JADX WARN: Removed duplicated region for block: B:374:0x0810  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.google.android.gms.internal.ads.q5 i(m3.p r70, k5.b r71, java.lang.String r72, j3.l r73, boolean r74) throws j3.d0 {
        /*
            Method dump skipped, instruction units count: 3468
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: k5.c.i(m3.p, k5.b, java.lang.String, j3.l, boolean):com.google.android.gms.internal.ads.q5");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:322:0x06d1  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:397:0x08b1  */
    /* JADX WARN: Removed duplicated region for block: B:401:0x08c6  */
    /* JADX WARN: Removed duplicated region for block: B:439:0x0976  */
    /* JADX WARN: Removed duplicated region for block: B:440:0x0978  */
    /* JADX WARN: Removed duplicated region for block: B:443:0x097e  */
    /* JADX WARN: Removed duplicated region for block: B:444:0x0981  */
    /* JADX WARN: Removed duplicated region for block: B:446:0x0984  */
    /* JADX WARN: Removed duplicated region for block: B:447:0x0987  */
    /* JADX WARN: Removed duplicated region for block: B:449:0x098a  */
    /* JADX WARN: Removed duplicated region for block: B:451:0x098e  */
    /* JADX WARN: Removed duplicated region for block: B:452:0x0991  */
    /* JADX WARN: Removed duplicated region for block: B:454:0x0994  */
    /* JADX WARN: Removed duplicated region for block: B:455:0x099a  */
    /* JADX WARN: Removed duplicated region for block: B:459:0x09a9  */
    /* JADX WARN: Removed duplicated region for block: B:481:0x0a35  */
    /* JADX WARN: Removed duplicated region for block: B:533:0x0203 A[SYNTHETIC] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static java.util.ArrayList j(n3.c r53, q4.q r54, long r55, j3.l r57, boolean r58, boolean r59, zc.e r60, boolean r61) {
        /*
            Method dump skipped, instruction units count: 2675
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: k5.c.j(n3.c, q4.q, long, j3.l, boolean, boolean, zc.e, boolean):java.util.ArrayList");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:141:0x0243, code lost:
        ...
        r9 = k5.p.h(r13, "MVIN", r1, true, false);
     */
    /* JADX WARN: Code restructure failed: missing block: B:142:0x024c, code lost:
    
        m3.b.d("MetadataUtil", "Skipped unknown metadata entry: " + com.google.android.gms.internal.ads.kv0.b(r13));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x0082, code lost:
        ...
        r9 = new e5.o("TCON", r12, ad.j0.w(r0));
     */
    /* JADX WARN: Code restructure failed: missing block: B:25:0x008c, code lost:
    
        m3.b.s("MetadataUtil", "Failed to parse standard genre code");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x00c4, code lost:
        ...
        r9 = k5.p.h(r13, "TCMP", r1, true, true);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x0123, code lost:
        ...
        r9 = k5.p.h(r13, "ITUNESADVISORY", r1, r3, r3);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:68:0x0130, code lost:
        ...
        r9 = k5.p.h(r13, "ITUNESGAPLESS", r1, r3, true);
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static j3.b0 k(n3.d r17) {
        /*
            Method dump skipped, instruction units count: 948
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: k5.c.k(n3.d):j3.b0");
    }
}

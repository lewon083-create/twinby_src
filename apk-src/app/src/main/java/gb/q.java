...
public abstract class q extends n implements List, RandomAccess {
    ...
    public static final o f20103c = new o(r.f20104f, 0);
    ...
    public q subList(int i, int i10) {
        hl.d.M(i, i10, size());
        int i11 = i10 - i;
        return i11 == size() ? this : i11 == 0 ? r.f20104f : new p(this, i, i11);
    }
    ...
    public final o listIterator(int i) {
        ...
        return isEmpty() ? f20103c : new o(this, i);
    }

...
public final class yw {
    ...
    public yw(Expression expression, Expression expression2, Expression expression3, Expression expression4, Expression expression5, Expression expression6, Expression expression7, JSONObject jSONObject) {
    }
}

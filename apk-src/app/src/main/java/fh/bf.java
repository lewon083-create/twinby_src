...
public final class bf {
    static {
        ...
        Expression.Companion.constant$default(companion, af.SCALE, null, 2, null);
    ...
    public bf(Expression expression, Expression expression2, List list, lo loVar, yw ywVar, List list2, lo loVar2) {
    }
}

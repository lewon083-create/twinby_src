...
public final class bx implements w83 {
    public static ix b(tg1 tg1Var, sw swVar) {
        String str = swVar.f43104c;
        try {
            ...
            boolean z5 = true;
            if (iOrdinal == 1) {
                int iA = ((vg1) tg1Var).a(-1, str);
                Integer numValueOf = Integer.valueOf(iA);
                if (iA == -1) {
                    numValueOf = null;
                }
                return new fx(numValueOf != null ? String.valueOf(numValueOf.intValue()) : null);
            }
            if (iOrdinal == 2) {
                if (((vg1) tg1Var).a(-1, str) == -1) {
                    z5 = false;
                }
                return new dx(z5);
            }
            ...
            if (iOrdinal == 5) {
                return new cx(((vg1) tg1Var).c(str));
            }
            throw new ij.j();
    ...
    public final ix a(tg1 tg1Var, String str) {
        ...
        if (str != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (Intrinsics.a(swVar.f43104c, str)) {
                    break;
                }
            }
            swVar = null;

...
public final class vu3 implements bk3 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f44179a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final pf3 f44180b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final jg3 f44181c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final List f44182d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final zj3 f44183e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final ea2 f44184f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final ko2 f44185g;
    ...
    public vu3(Context context, pf3 pf3Var, jg3 jg3Var, List list, zj3 zj3Var, ea2 ea2Var, ko2 ko2Var) {
    ...
    public final void b() {
        ...
        if (kl1Var != null) {
            try {
                ...
                hx3.a(kl1Var.f40243a);
                kl1Var.f40243a.f45556e.a("complete", (JSONObject) null);
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }
        }
    }
    ...
    public final void c() {
        ...
        if (kl1Var != null) {
            try {
                ...
                hx3.a(kl1Var.f40243a);
                kl1Var.f40243a.f45556e.a("resume", (JSONObject) null);
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }
        }
    ...
    public final void d() {
        ...
        if (kl1Var != null) {
            try {
                ...
                hx3.a(kl1Var.f40243a);
                kl1Var.f40243a.f45556e.a("pause", (JSONObject) null);
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }
        }
    ...
    public final void f() {
        ...
        if (kl1Var != null) {
            try {
                ...
                hx3.a(kl1Var.f40243a);
                kl1Var.f40243a.f45556e.a("bufferStart", (JSONObject) null);
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }
        }
    ...
    public final void j() {
        ...
        if (kl1Var != null) {
            try {
                ...
                hx3.a(kl1Var.f40243a);
                kl1Var.f40243a.f45556e.a("bufferFinish", (JSONObject) null);
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }
        }
    ...
    public final void m() {
        ...
        if (kl1Var != null) {
            try {
                ...
                sc1 sc1Var = sc1.f42898c;
                hx3.a(kl1Var.f40243a);
                JSONObject jSONObject = new JSONObject();
                ow3.a(jSONObject, "interactionType", sc1Var);
                kl1Var.f40243a.f45556e.a("adUserInteraction", jSONObject);
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }
        }
    ...
    public final ca2 a(Context context) {
        pt2 pt2VarA;
        zv3 zv3Var;
        aa2 aa2VarA = ba2.a(context);
        t92 t92VarA = s92.a();
        gw2 gw2VarA = fw2.a();
        Context applicationContext = context.getApplicationContext();
        List list = this.f44182d;
        ca2 ca2Var = null;
        if (tb.a(applicationContext) && (pt2VarA = gw2VarA.a(applicationContext)) != null && !pt2VarA.f42059w) {
            synchronized (t92.f43247c) {
                try {
                    if (t92VarA.f43249a.a(applicationContext) && !t92VarA.f43250b) {
                        ga2.a(applicationContext);
                        t92VarA.f43250b = true;
                    }
            ...
            while (it.hasNext()) {
                try {
                    eVarB.add(fa2.a((jd3) it.next()));
                } catch (ld3 e3) {
                    Map mapC = kotlin.collections.i0.c(new Pair("[REASON]", String.valueOf(e3.f40510c.f40170b)));
                    zj3 zj3Var = this.f44183e;
                    jd3 jd3Var = e3.f40509b;
                    zj3Var.getClass();
                    List list2 = (List) jd3Var.a().get("verificationNotExecuted");
                    if (list2 != null) {
                        zj3Var.f45442a.a(list2, mapC);
                    }
            ...
            if (eVarA.isEmpty()) {
                ...
                String strC = ((vg1) aa2VarA.f36669a).c("YmadOmSdkJs");
                if (strC == null) {
                    strC = "";
                }
                if (strC.length() == 0) {
                ...
                if (!TextUtils.isEmpty("7.18.4")) {
                    ia iaVar = new ia(new tb2(), strC, eVarA);
                    ha haVar = new ha();
                    if (ga2.f38688a.f40709a) {
                        zv3Var = new zv3(haVar, iaVar, UUID.randomUUID().toString());
                    } else {
            ...
            if (zv3Var != null) {
                if (gb2.f38693c == zv3Var.f45553b.f39112b) {
                    if (!zv3Var.f45557f) {
                        boolean z5 = zv3Var.f45558g;
                        if (!z5) {
                            ka kaVar = zv3Var.f45556e;
                            if (kaVar.f40129d == null) {
                                kl1 kl1Var = new kl1(zv3Var);
                                kaVar.f40129d = kl1Var;
                                if (kaVar.f40128c != null) {
                                    throw new IllegalStateException("AdEvents already exists for AdSession");
                                }
                                if (!z5) {
                                    e4 e4Var = new e4(zv3Var);
                                    kaVar.f40128c = e4Var;
                                    ca2Var = new ca2(zv3Var, kl1Var, e4Var);
                                } else {
    ...
    public final void a(View view, List list) {
        ...
        Unit unit = Unit.f27471a;
        try {
            ca2 ca2VarA = a(this.f44179a);
            if (ca2VarA != null) {
                zv3 zv3Var = ca2VarA.f37324a;
                zv3Var.a(view);
                this.f44186h = zv3Var;
                this.i = ca2VarA.f37325b;
                this.f44187j = ca2VarA.f37326c;
            }
        } catch (Exception e3) {
            this.f44185g.reportError("Failed to execute safely", e3);
        }
        ...
        if (zv3Var2 != null) {
            try {
                ...
                this.f44185g.reportError("Failed to execute safely", e7);
            }
        }
        e4 e4Var = this.f44187j;
        if (e4Var != null) {
            try {
                ...
                ea2 ea2Var = this.f44184f;
                jg3 jg3Var = this.f44181c;
                pf3 pf3Var = this.f44180b;
                ea2Var.getClass();
                int iOrdinal = pf3Var.ordinal();
                if (iOrdinal == 0) {
                    hg2Var = hg2.f39176c;
                } else if (iOrdinal == 1) {
                    hg2Var = hg2.f39177d;
                ...
                if (jg3Var != null) {
                    qc3Var = new qc3(true, Float.valueOf(jg3Var.f39866a / 1000), hg2Var);
                } else {
                    qc3Var = new qc3(false, null, hg2Var);
                }
                e4Var.a(qc3Var);
            } catch (Exception e10) {
                this.f44185g.reportError("Failed to execute safely", e10);
            }
        }
    }
    ...
    public final void a(ak3 ak3Var) {
        ...
        if (kl1Var != null) {
            try {
                ...
                if (iOrdinal == 0) {
                    hx3.a(kl1Var.f40243a);
                    kl1Var.f40243a.f45556e.a("firstQuartile", (JSONObject) null);
                } else if (iOrdinal == 1) {
                    hx3.a(kl1Var.f40243a);
                    kl1Var.f40243a.f45556e.a("midpoint", (JSONObject) null);
                } else {
                    if (iOrdinal != 2) {
                        return;
                    }
                    hx3.a(kl1Var.f40243a);
                    kl1Var.f40243a.f45556e.a("thirdQuartile", (JSONObject) null);
                }
            } catch (Exception e3) {
                this.f44185g.reportError("Failed to execute safely", e3);
            }

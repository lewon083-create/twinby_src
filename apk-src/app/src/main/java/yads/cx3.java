...
public final class cx3 extends xv3 {
    public cx3(iw3 iw3Var, HashSet hashSet, JSONObject jSONObject, long j10) {
        ...
        if (qw3Var != null) {
            for (zv3 zv3Var : Collections.unmodifiableCollection(qw3Var.f42412a)) {
                if (this.f44816c.contains(zv3Var.f45559h)) {
                    ...
                    if (this.f44818e >= kaVar.f40131f && kaVar.f40130e != 3) {
                        kaVar.f40130e = 3;

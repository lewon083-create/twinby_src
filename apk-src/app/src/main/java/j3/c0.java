...
public abstract class c0 {
    ...
    public static final ArrayList f26222a = new ArrayList();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final Pattern f26223b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");
    ...
    public static boolean a(String str, String str2) {
        ...
        switch (str) {
            case "audio/mp4a-latm":
                if (str2 != null && (c3VarF = f(str2)) != null && (iA = c3VarF.a()) != 0 && iA != 16) {
                }
                break;
        }
        return false;
    ...
    public static int c(String str, String str2) {
        ...
        switch (str) {
            ...
            case "audio/vnd.dts":
                return 7;
            case "audio/mp4a-latm":
                if (str2 == null || (c3VarF = f(str2)) == null) {
                    return 0;
                }
                return c3VarF.a();
            case "audio/ac3":
    ...
    public static String d(String str) {
        ...
        if (str != null) {
            ...
            if (strX.startsWith("mp4a")) {
                if (strX.startsWith("mp4a.") && (c3VarF = f(strX)) != null) {
                    strE = e(c3VarF.f4005a);
                }
    ...
    public static c3 f(String str) {
        Matcher matcher = f26223b.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
        ...
        try {
            return new c3(Integer.parseInt(strGroup, 16), strGroup2 != null ? Integer.parseInt(strGroup2) : 0);
    ...
    public static boolean m(String str) {
        return RRWebVideoEvent.EVENT_TAG.equals(g(str));
    }

...
public abstract class q4 {
    ...
    public static int b(int i, int i10, String str, byte[] bArr) {
        int i11;
        int i12;
        int i13;
        char cCharAt;
    ...
    */
    public static boolean d(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.q4.d(byte[], int, int):boolean");
    }
}

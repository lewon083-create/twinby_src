...
public final class vr implements w9.c {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final /* synthetic */ int f11447b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final /* synthetic */ nr f11448c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final /* synthetic */ yr f11449d;

    public /* synthetic */ vr(yr yrVar, nr nrVar, int i) {
        this.f11447b = i;
        this.f11448c = nrVar;
        this.f11449d = yrVar;
    }
    ...
    public final void w(la.m mVar) {
        switch (this.f11447b) {
            case 0:
                int i = mVar.f28098c;
                try {
                    String canonicalName = this.f11449d.f12691b.getClass().getCanonicalName();
            ...
            default:
                ...
                try {
                    String canonicalName2 = this.f11449d.f12691b.getClass().getCanonicalName();

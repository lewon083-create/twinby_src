...
public final class VKAuthResult {
    ...
    public /* synthetic */ VKAuthResult(VKAccessToken vKAccessToken, int i, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(vKAccessToken, (i10 & 2) != 0 ? 0 : i);
    }
}

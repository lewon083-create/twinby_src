...
@Metadata
public final class LoggingInterceptor$sensitiveKeyRequestTransformer$2 extends r implements Function0<Function1<? super MatchResult, ? extends String>> {
    ...
    /* JADX INFO: renamed from: com.vk.api.sdk.okhttp.LoggingInterceptor$sensitiveKeyRequestTransformer$2$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-c151d27eb9f4c00b335bd72ad6c9ab5c682fb50bb0d055f47144f326a6351039 */
    @Metadata
    public static final class AnonymousClass1 extends r implements Function1<MatchResult, String> {
        ...
        public final String invoke(MatchResult match) {
            ...
            return Intrinsics.f("=<HIDE>", (String) match.a().get(1));
        }
    }

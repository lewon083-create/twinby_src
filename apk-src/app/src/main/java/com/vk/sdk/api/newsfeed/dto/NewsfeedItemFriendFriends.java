...
public final class NewsfeedItemFriendFriends {
    ...
    @NotNull
    public final NewsfeedItemFriendFriends copy(@Nullable Integer num, @Nullable List<BaseUserId> list) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, newsfeedItemFriendFriends.count) && Intrinsics.a(this.items, newsfeedItemFriendFriends.items);
    }
    ...
    public String toString() {
        return a.j("NewsfeedItemFriendFriends(count=", this.count, ", items=", this.items, ")");
    }

    public NewsfeedItemFriendFriends(@Nullable Integer num, @Nullable List<BaseUserId> list) {
        this.count = num;
        this.items = list;
    }

    public /* synthetic */ NewsfeedItemFriendFriends(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

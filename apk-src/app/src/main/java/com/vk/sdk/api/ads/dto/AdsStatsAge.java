...
public final class AdsStatsAge {
    ...
    public static /* synthetic */ AdsStatsAge copy$default(AdsStatsAge adsStatsAge, Float f10, Float f11, String str, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public String toString() {
        ...
        Float f11 = this.impressionsRate;
        String str = this.value;
        StringBuilder sb2 = new StringBuilder("AdsStatsAge(clicksRate=");
        sb2.append(f10);
    ...
    public /* synthetic */ AdsStatsAge(Float f10, Float f11, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {

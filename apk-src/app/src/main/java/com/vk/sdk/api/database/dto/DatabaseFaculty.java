...
public final class DatabaseFaculty {
    ...
    @b("id")
    @Nullable
    private final Integer f15159id;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.f15159id, databaseFaculty.f15159id) && Intrinsics.a(this.title, databaseFaculty.title);
    }
    ...
    public String toString() {
        return "DatabaseFaculty(id=" + this.f15159id + ", title=" + this.title + ")";
    }
    ...
    public /* synthetic */ DatabaseFaculty(Integer num, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {

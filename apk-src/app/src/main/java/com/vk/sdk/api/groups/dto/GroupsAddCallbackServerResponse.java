...
public final class GroupsAddCallbackServerResponse {
    ...
    public static /* synthetic */ GroupsAddCallbackServerResponse copy$default(GroupsAddCallbackServerResponse groupsAddCallbackServerResponse, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public String toString() {
        return u.k(this.serverId, "GroupsAddCallbackServerResponse(serverId=", ")");
    }
}

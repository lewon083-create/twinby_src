...
public final class VideoAddAlbumResponse {
    ...
    public static /* synthetic */ VideoAddAlbumResponse copy$default(VideoAddAlbumResponse videoAddAlbumResponse, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public String toString() {
        return u.k(this.albumId, "VideoAddAlbumResponse(albumId=", ")");
    }
}

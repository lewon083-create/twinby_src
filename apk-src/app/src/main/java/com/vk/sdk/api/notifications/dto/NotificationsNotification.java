...
public final class NotificationsNotification {
    ...
    public static /* synthetic */ NotificationsNotification copy$default(NotificationsNotification notificationsNotification, Integer num, NotificationsFeedback notificationsFeedback, NotificationsNotification notificationsNotification2, NotificationsReply notificationsReply, String str, int i, Object obj) {
        ...
        return notificationsNotification.copy(num, notificationsFeedback, notificationsNotification3, notificationsReply, str2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.date, notificationsNotification.date) && Intrinsics.a(this.feedback, notificationsNotification.feedback) && Intrinsics.a(this.parent, notificationsNotification.parent) && Intrinsics.a(this.reply, notificationsNotification.reply) && Intrinsics.a(this.type, notificationsNotification.type);
    }
    ...
    public String toString() {
        ...
        NotificationsReply notificationsReply = this.reply;
        String str = this.type;
        StringBuilder sb2 = new StringBuilder("NotificationsNotification(date=");
        sb2.append(num);
        sb2.append(", feedback=");
    ...
    public /* synthetic */ NotificationsNotification(Integer num, NotificationsFeedback notificationsFeedback, NotificationsNotification notificationsNotification, NotificationsReply notificationsReply, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {

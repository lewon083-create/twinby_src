...
public final class WallPostAdsStealthResponse {
    ...
    public static /* synthetic */ WallPostAdsStealthResponse copy$default(WallPostAdsStealthResponse wallPostAdsStealthResponse, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public String toString() {
        return u.k(this.postId, "WallPostAdsStealthResponse(postId=", ")");
    }
}

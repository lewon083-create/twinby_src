...
public final class MessagesMessagesArray {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, messagesMessagesArray.count) && Intrinsics.a(this.items, messagesMessagesArray.items);
    }
    ...
    public String toString() {
        return a.j("MessagesMessagesArray(count=", this.count, ", items=", this.items, ")");
    }
    ...
    public /* synthetic */ MessagesMessagesArray(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

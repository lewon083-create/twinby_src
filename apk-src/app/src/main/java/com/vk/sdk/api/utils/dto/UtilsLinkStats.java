...
public final class UtilsLinkStats {
    ...
    public static /* synthetic */ UtilsLinkStats copy$default(UtilsLinkStats utilsLinkStats, String str, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.key, utilsLinkStats.key) && Intrinsics.a(this.stats, utilsLinkStats.stats);
    }
    ...
    public String toString() {
        return "UtilsLinkStats(key=" + this.key + ", stats=" + this.stats + ")";
    }
    ...
    public /* synthetic */ UtilsLinkStats(String str, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

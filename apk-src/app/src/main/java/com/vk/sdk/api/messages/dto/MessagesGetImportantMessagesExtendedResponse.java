...
public final class MessagesGetImportantMessagesExtendedResponse {
    ...
    public static /* synthetic */ MessagesGetImportantMessagesExtendedResponse copy$default(MessagesGetImportantMessagesExtendedResponse messagesGetImportantMessagesExtendedResponse, MessagesMessagesArray messagesMessagesArray, List list, List list2, List list3, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.messages, messagesGetImportantMessagesExtendedResponse.messages) && Intrinsics.a(this.profiles, messagesGetImportantMessagesExtendedResponse.profiles) && Intrinsics.a(this.groups, messagesGetImportantMessagesExtendedResponse.groups) && Intrinsics.a(this.conversations, messagesGetImportantMessagesExtendedResponse.conversations);
    }
    ...
    public String toString() {
        ...
        List<GroupsGroupFull> list2 = this.groups;
        List<MessagesConversation> list3 = this.conversations;
        StringBuilder sb2 = new StringBuilder("MessagesGetImportantMessagesExtendedResponse(messages=");
    ...
    public /* synthetic */ MessagesGetImportantMessagesExtendedResponse(MessagesMessagesArray messagesMessagesArray, List list, List list2, List list3, int i, DefaultConstructorMarker defaultConstructorMarker) {

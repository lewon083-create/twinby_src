...
public final class FaveGetTagsResponse {
    ...
    public static /* synthetic */ FaveGetTagsResponse copy$default(FaveGetTagsResponse faveGetTagsResponse, Integer num, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, faveGetTagsResponse.count) && Intrinsics.a(this.items, faveGetTagsResponse.items);
    }
    ...
    public String toString() {
        return a.j("FaveGetTagsResponse(count=", this.count, ", items=", this.items, ")");
    }
    ...
    public /* synthetic */ FaveGetTagsResponse(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

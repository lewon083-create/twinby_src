...
public final class GroupsGetCatalogInfoResponse {
    ...
    public static /* synthetic */ GroupsGetCatalogInfoResponse copy$default(GroupsGetCatalogInfoResponse groupsGetCatalogInfoResponse, BaseBoolInt baseBoolInt, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.enabled == groupsGetCatalogInfoResponse.enabled && Intrinsics.a(this.categories, groupsGetCatalogInfoResponse.categories);
    }
    ...
    public /* synthetic */ GroupsGetCatalogInfoResponse(BaseBoolInt baseBoolInt, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

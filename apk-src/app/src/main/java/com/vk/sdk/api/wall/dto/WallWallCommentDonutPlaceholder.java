...
public final class WallWallCommentDonutPlaceholder {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof WallWallCommentDonutPlaceholder) && Intrinsics.a(this.text, ((WallWallCommentDonutPlaceholder) obj).text);
    }
    ...
    public String toString() {
        return a.f("WallWallCommentDonutPlaceholder(text=", this.text, ")");
    }
}

...
public final class GiftsGetResponse {
    ...
    @NotNull
    public final GiftsGetResponse copy(@Nullable Integer num, @Nullable List<GiftsGift> list) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, giftsGetResponse.count) && Intrinsics.a(this.items, giftsGetResponse.items);
    }
    ...
    public String toString() {
        return a.j("GiftsGetResponse(count=", this.count, ", items=", this.items, ")");
    }

    public GiftsGetResponse(@Nullable Integer num, @Nullable List<GiftsGift> list) {
        this.count = num;
        this.items = list;
    }

    public /* synthetic */ GiftsGetResponse(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

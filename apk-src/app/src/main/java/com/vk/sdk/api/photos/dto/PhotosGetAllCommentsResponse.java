...
public final class PhotosGetAllCommentsResponse {
    ...
    @NotNull
    public final PhotosGetAllCommentsResponse copy(@Nullable Integer num, @Nullable List<WallWallComment> list) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, photosGetAllCommentsResponse.count) && Intrinsics.a(this.items, photosGetAllCommentsResponse.items);
    }
    ...
    public String toString() {
        return a.j("PhotosGetAllCommentsResponse(count=", this.count, ", items=", this.items, ")");
    }

    public PhotosGetAllCommentsResponse(@Nullable Integer num, @Nullable List<WallWallComment> list) {
        this.count = num;
        this.items = list;
    }

    public /* synthetic */ PhotosGetAllCommentsResponse(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

...
public final class PhotosSearchResponse {
    ...
    public static /* synthetic */ PhotosSearchResponse copy$default(PhotosSearchResponse photosSearchResponse, Integer num, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, photosSearchResponse.count) && Intrinsics.a(this.items, photosSearchResponse.items);
    }
    ...
    public String toString() {
        return a.j("PhotosSearchResponse(count=", this.count, ", items=", this.items, ")");
    }
    ...
    public /* synthetic */ PhotosSearchResponse(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

...
public final class MarketGetResponse {
    ...
    public static /* synthetic */ MarketGetResponse copy$default(MarketGetResponse marketGetResponse, Integer num, List list, List list2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, marketGetResponse.count) && Intrinsics.a(this.items, marketGetResponse.items) && Intrinsics.a(this.variants, marketGetResponse.variants);
    }
    ...
    public String toString() {
        ...
        List<MarketMarketItem> list = this.items;
        List<MarketMarketItem> list2 = this.variants;
        StringBuilder sb2 = new StringBuilder("MarketGetResponse(count=");
        sb2.append(num);
        sb2.append(", items=");
        sb2.append(list);
        sb2.append(", variants=");
    ...
    public /* synthetic */ MarketGetResponse(Integer num, List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {

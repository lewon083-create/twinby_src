...
public final class FriendsRequestsMutual {
    ...
    public static /* synthetic */ FriendsRequestsMutual copy$default(FriendsRequestsMutual friendsRequestsMutual, Integer num, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, friendsRequestsMutual.count) && Intrinsics.a(this.users, friendsRequestsMutual.users);
    }
    ...
    public String toString() {
        return a.j("FriendsRequestsMutual(count=", this.count, ", users=", this.users, ")");
    }
    ...
    public /* synthetic */ FriendsRequestsMutual(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

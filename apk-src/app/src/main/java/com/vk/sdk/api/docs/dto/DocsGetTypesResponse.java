...
public final class DocsGetTypesResponse {
    ...
    public static /* synthetic */ DocsGetTypesResponse copy$default(DocsGetTypesResponse docsGetTypesResponse, Integer num, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, docsGetTypesResponse.count) && Intrinsics.a(this.items, docsGetTypesResponse.items);
    }
    ...
    public String toString() {
        return a.j("DocsGetTypesResponse(count=", this.count, ", items=", this.items, ")");
    }
    ...
    public /* synthetic */ DocsGetTypesResponse(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

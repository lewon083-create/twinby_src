...
public final class NewsfeedItemPhotoTagPhotoTags {
    ...
    public static /* synthetic */ NewsfeedItemPhotoTagPhotoTags copy$default(NewsfeedItemPhotoTagPhotoTags newsfeedItemPhotoTagPhotoTags, Integer num, List list, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, newsfeedItemPhotoTagPhotoTags.count) && Intrinsics.a(this.items, newsfeedItemPhotoTagPhotoTags.items);
    }
    ...
    public String toString() {
        return a.j("NewsfeedItemPhotoTagPhotoTags(count=", this.count, ", items=", this.items, ")");
    }
    ...
    public /* synthetic */ NewsfeedItemPhotoTagPhotoTags(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

...
public final class AppsGetLeaderboardResponse {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, appsGetLeaderboardResponse.count) && Intrinsics.a(this.items, appsGetLeaderboardResponse.items);
    }
    ...
    public String toString() {
        return a.j("AppsGetLeaderboardResponse(count=", this.count, ", items=", this.items, ")");
    }
    ...
    public /* synthetic */ AppsGetLeaderboardResponse(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

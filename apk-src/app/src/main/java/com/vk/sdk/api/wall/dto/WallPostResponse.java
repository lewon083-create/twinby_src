...
public final class WallPostResponse {
    ...
    public static /* synthetic */ WallPostResponse copy$default(WallPostResponse wallPostResponse, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public String toString() {
        return u.k(this.postId, "WallPostResponse(postId=", ")");
    }
}

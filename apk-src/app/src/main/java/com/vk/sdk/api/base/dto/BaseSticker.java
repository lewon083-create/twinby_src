...
public final class BaseSticker {
    ...
    public static /* synthetic */ BaseSticker copy$default(BaseSticker baseSticker, Integer num, Integer num2, List list, List list2, String str, List list3, Boolean bool, int i, Object obj) {
        ...
        String str2 = str;
        List list5 = list;
        return baseSticker.copy(num, num2, list5, list2, str2, list4, bool2);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.stickerId, baseSticker.stickerId) && Intrinsics.a(this.productId, baseSticker.productId) && Intrinsics.a(this.images, baseSticker.images) && Intrinsics.a(this.imagesWithBackground, baseSticker.imagesWithBackground) && Intrinsics.a(this.animationUrl, baseSticker.animationUrl) && Intrinsics.a(this.animations, baseSticker.animations) && Intrinsics.a(this.isAllowed, baseSticker.isAllowed);
    }
    ...
    public String toString() {
        ...
        List<BaseStickerAnimation> list3 = this.animations;
        Boolean bool = this.isAllowed;
        StringBuilder sbO = om1.o("BaseSticker(stickerId=", ", productId=", num, num2, ", images=");
    ...
    public /* synthetic */ BaseSticker(Integer num, Integer num2, List list, List list2, String str, List list3, Boolean bool, int i, DefaultConstructorMarker defaultConstructorMarker) {

...
public final class MessagesOutReadBy {
    ...
    @NotNull
    public final MessagesOutReadBy copy(@Nullable Integer num, @Nullable List<UserId> list) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, messagesOutReadBy.count) && Intrinsics.a(this.memberIds, messagesOutReadBy.memberIds);
    }
    ...
    public String toString() {
        return a.j("MessagesOutReadBy(count=", this.count, ", memberIds=", this.memberIds, ")");
    }

    public MessagesOutReadBy(@Nullable Integer num, @Nullable List<UserId> list) {
        this.count = num;
        this.memberIds = list;
    }

    public /* synthetic */ MessagesOutReadBy(Integer num, List list, int i, DefaultConstructorMarker defaultConstructorMarker) {

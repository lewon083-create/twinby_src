...
public final class MessagesDeleteChatPhotoResponse {
    ...
    public static /* synthetic */ MessagesDeleteChatPhotoResponse copy$default(MessagesDeleteChatPhotoResponse messagesDeleteChatPhotoResponse, Integer num, MessagesChat messagesChat, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    @NotNull
    public final MessagesDeleteChatPhotoResponse copy(@Nullable Integer num, @Nullable MessagesChat messagesChat) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.messageId, messagesDeleteChatPhotoResponse.messageId) && Intrinsics.a(this.chat, messagesDeleteChatPhotoResponse.chat);
    }
    ...
    public MessagesDeleteChatPhotoResponse(@Nullable Integer num, @Nullable MessagesChat messagesChat) {
        this.messageId = num;
        this.chat = messagesChat;
    }

    public /* synthetic */ MessagesDeleteChatPhotoResponse(Integer num, MessagesChat messagesChat, int i, DefaultConstructorMarker defaultConstructorMarker) {

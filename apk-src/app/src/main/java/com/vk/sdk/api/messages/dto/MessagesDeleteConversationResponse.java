...
public final class MessagesDeleteConversationResponse {
    ...
    public static /* synthetic */ MessagesDeleteConversationResponse copy$default(MessagesDeleteConversationResponse messagesDeleteConversationResponse, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    public String toString() {
        return u.k(this.lastDeletedId, "MessagesDeleteConversationResponse(lastDeletedId=", ")");
    }
}

...
public final class WallGetByIdExtendedResponse {
    ...
    public static /* synthetic */ WallGetByIdExtendedResponse copy$default(WallGetByIdExtendedResponse wallGetByIdExtendedResponse, List list, List list2, List list3, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.items, wallGetByIdExtendedResponse.items) && Intrinsics.a(this.profiles, wallGetByIdExtendedResponse.profiles) && Intrinsics.a(this.groups, wallGetByIdExtendedResponse.groups);
    }
    ...
    public String toString() {
        ...
        StringBuilder sb2 = new StringBuilder("WallGetByIdExtendedResponse(items=");
        sb2.append(list);
        sb2.append(", profiles=");
        sb2.append(list2);
        sb2.append(", groups=");

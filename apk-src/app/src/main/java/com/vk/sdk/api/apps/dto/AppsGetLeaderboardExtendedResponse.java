...
public final class AppsGetLeaderboardExtendedResponse {
    ...
    public static /* synthetic */ AppsGetLeaderboardExtendedResponse copy$default(AppsGetLeaderboardExtendedResponse appsGetLeaderboardExtendedResponse, Integer num, List list, List list2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Intrinsics.a(this.count, appsGetLeaderboardExtendedResponse.count) && Intrinsics.a(this.items, appsGetLeaderboardExtendedResponse.items) && Intrinsics.a(this.profiles, appsGetLeaderboardExtendedResponse.profiles);
    }
    ...
    public String toString() {
        ...
        List<AppsLeaderboard> list = this.items;
        List<UsersUser> list2 = this.profiles;
        StringBuilder sb2 = new StringBuilder("AppsGetLeaderboardExtendedResponse(count=");
        sb2.append(num);
        sb2.append(", items=");
        sb2.append(list);
        sb2.append(", profiles=");
    ...
    public /* synthetic */ AppsGetLeaderboardExtendedResponse(Integer num, List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {

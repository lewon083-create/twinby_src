...
@Metadata
public final class DivStorageComponent$Companion$create$1 extends r implements Function0<DivParsingHistogramReporter> {
    public static final DivStorageComponent$Companion$create$1 INSTANCE = new DivStorageComponent$Companion$create$1();

    public DivStorageComponent$Companion$create$1() {
        super(0);
    }

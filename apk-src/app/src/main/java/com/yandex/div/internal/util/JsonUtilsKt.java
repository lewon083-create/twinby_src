...
public abstract class JsonUtilsKt {
    ...
    public static /* synthetic */ String summary$default(JSONObject jSONObject, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            i = 0;
        }
    ...
    public static /* synthetic */ String summary$default(JSONArray jSONArray, int i, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            i = 0;
        }

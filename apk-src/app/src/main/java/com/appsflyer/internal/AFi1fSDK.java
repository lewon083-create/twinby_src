...
public class AFi1fSDK {
    ...
    private static Object f2452d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static Object f2453e;
    ...
    private static int f2454v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public static final Map f2455w;
    ...
    static {
        /*
            Method dump skipped, instruction units count: 8058
    ...
    public static int getCurrencyIso4217Code(int i10) throws Throwable {
        ...
        try {
            ...
            byte[] bArr = $$a;
            int iIntValue = ((Integer) Class.forName($$c(bArr[27], bArr[82], (short) 563), true, (ClassLoader) f2453e).getMethod($$c(bArr[718], bArr[427], (short) 1167), Integer.TYPE).invoke(obj, objArr)).intValue();
            $10 = ($11 + 41) % 128;
            return iIntValue;
        } catch (Throwable th2) {
    ...
    public static Object getMediationNetwork(char c8, int i10, int i11) throws Throwable {
        int i12 = $10;
        Object obj = f2452d;
        ...
        try {
            Object[] objArr = {Character.valueOf(c8), Integer.valueOf(i10), Integer.valueOf(i11)};
            byte[] bArr = $$a;
            Class<?> cls = Class.forName($$c(bArr[27], bArr[82], (short) 563), true, (ClassLoader) f2453e);
            String str$$c = $$c(bArr[506], bArr[427], (short) 1128);
    ...
    public static int getCurrencyIso4217Code(Object obj) throws Throwable {
        ...
        try {
            byte[] bArr = $$a;
            int iIntValue = ((Integer) Class.forName($$c(bArr[27], bArr[82], (short) 563), true, (ClassLoader) f2453e).getMethod($$c(bArr[452], bArr[427], (short) ($$b | 1034)), Object.class).invoke(obj2, obj)).intValue();
            $10 = ($11 + 9) % 128;
            return iIntValue;
        } catch (Throwable th2) {
            Throwable cause = th2.getCause();

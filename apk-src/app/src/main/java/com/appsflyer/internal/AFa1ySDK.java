...
public final class AFa1ySDK extends AppsFlyerLib {
    ...
    /* JADX WARN: Removed duplicated region for block: B:9:0x0049 A[PHI: r1 r2
      0x0049: PHI (r1v4 com.appsflyer.internal.AFh1xSDK) = (r1v3 com.appsflyer.internal.AFh1xSDK), (r1v8 com.appsflyer.internal.AFh1xSDK) binds: [B:8:0x0047, B:5:0x0031] A[DONT_GENERATE, DONT_INLINE]
      0x0049: PHI (r2v4 com.appsflyer.internal.AFh1vSDK) = (r2v3 com.appsflyer.internal.AFh1vSDK), (r2v5 com.appsflyer.internal.AFh1vSDK) binds: [B:8:0x0047, B:5:0x0031] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:15:0x005b A[Catch: all -> 0x003c, JSONException -> 0x003f, PHI: r3
      0x005b: PHI (r3v3 long) = (r3v2 long), (r3v14 long) binds: [B:14:0x0059, B:6:0x0039] A[DONT_GENERATE, DONT_INLINE], TryCatch #2 {JSONException -> 0x003f, all -> 0x003c, blocks: (B:5:0x002a, B:16:0x0066, B:18:0x0071, B:21:0x008a, B:25:0x009d, B:26:0x00a0, B:30:0x00b3, B:31:0x00b6, B:20:0x0085, B:15:0x005b, B:13:0x004d), top: B:37:0x001d }] */
    /* JADX WARN: Removed duplicated region for block: B:16:0x0066 A[Catch: all -> 0x003c, JSONException -> 0x003f, PHI: r3 r7
      0x0066: PHI (r3v12 long) = (r3v2 long), (r3v14 long) binds: [B:14:0x0059, B:6:0x0039] A[DONT_GENERATE, DONT_INLINE]
      0x0066: PHI (r7v3 java.lang.String) = (r7v0 java.lang.String), (r7v8 java.lang.String) binds: [B:14:0x0059, B:6:0x0039] A[DONT_GENERATE, DONT_INLINE], TryCatch #2 {JSONException -> 0x003f, all -> 0x003c, blocks: (B:5:0x002a, B:16:0x0066, B:18:0x0071, B:21:0x008a, B:25:0x009d, B:26:0x00a0, B:30:0x00b3, B:31:0x00b6, B:20:0x0085, B:15:0x005b, B:13:0x004d), top: B:37:0x001d }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    private static /* synthetic */ Object copy(Object[] objArr) {
        ...
        try {
            ...
            AFLogger.INSTANCE.e(AFg1cSDK.GENERAL, "Exception while validation permissions. ", e3);
            return null;
        }
    }
    ...
    */
    public /* synthetic */ void e_(android.content.Context r7, android.content.Intent r8) {
        /*
            ...
            com.appsflyer.internal.AFd1zSDK r0 = r6.getMonetizationNetwork()
            com.appsflyer.internal.AFa1mSDK r0 = r0.i()
            com.appsflyer.internal.AFd1zSDK r1 = r6.getMonetizationNetwork()
        ...
        L38:
            ...
            int r5 = r5 + 33
            int r5 = r5 % 128
            com.appsflyer.internal.AFa1ySDK.AFKeystoreWrapper = r5
        ...
        L5d:
            ...
            boolean r1 = r1.getMediationNetwork(r5, r4)
            if (r1 == 0) goto L6d
            if (r3 != 0) goto L6d
            java.lang.String r7 = "No direct deep link"
            r0.getMediationNetwork(r7, r2)
            return
        L6d:
    ...
    public static /* synthetic */ Object getRevenue(Object[] objArr, int i10, int i11, int i12) {
        String strConcat;
        int i13 = (i11 * (-755)) + (i10 * (-755));
        int i14 = ~((~i10) | (~i11));
        int i15 = i10 | i11;
        int i16 = ((~(i15 | i12)) | i14) * (-756);
        int i17 = (i15 | (~i12)) * 756;
        boolean z5 = true;
        switch (i17 + i16 + (i14 * 1512) + i13) {
            case 1:
                AFa1ySDK aFa1ySDK = (AFa1ySDK) objArr[0];
            ...
            case 12:
                ...
                monetizationNetwork.getMonetizationNetwork().submit(new e(1, monetizationNetwork));
                if (zBooleanValue) {
            ...
            case 18:
                ...
                if (revenue == null || !str4.equals(revenue.getRevenue)) {
                    ...
                    AFf1aSDK aFf1aSDK = new AFf1aSDK(str4, jCurrentTimeMillis, !z5);
    ...
    public final AppsFlyerLib init(String str, AppsFlyerConversionListener appsFlyerConversionListener, Context context) {
        ...
        if (context != null) {
            ...
            getMonetizationNetwork().getMonetizationNetwork().execute(new Runnable(this) { // from class: com.appsflyer.internal.b
                ...
                public final /* synthetic */ AFa1ySDK f2459c;
        ...
        aFd1oSDKCopy.getRevenue(Session.JsonKeys.INIT, str, str2);
        AFLogger.INSTANCE.force(AFg1cSDK.GENERAL, "Initializing AppsFlyer SDK: (v6.17.6." + getMonetizationNetwork + ")");
    ...
    public final void performOnAppAttribution(Context context, URI uri) {
        if (uri != null) {
            ...
            if (!uri.toString().isEmpty()) {
                if (context == null) {
                    ...
                    sb2.append(context);
                    sb2.append("\"");
                    aFa1mSDKI.getMediationNetwork(sb2.toString(), DeepLinkResult.Error.NETWORK);
                    return;
                }
                AFAdRevenueData(context);
        ...
        sb3.append(uri);
        sb3.append("\"");
        aFa1mSDKI2.getMediationNetwork(sb3.toString(), DeepLinkResult.Error.NETWORK);
    }
    ...
    public final void performOnDeepLinking(Intent intent, Context context) {
        ...
        getMonetizationNetwork().getMonetizationNetwork().execute(new a1.c(this, applicationContext, intent, 2));
        int i11 = i + 121;
        AFKeystoreWrapper = i11 % 128;
        if (i11 % 2 != 0) {
            throw null;
    ...
    */
    ...
    public final void setDisableAdvertisingIdentifiers(boolean z5) {
        ...
        AFb1lSDK.AFAdRevenueData = Boolean.valueOf(z10);
        AFd1zSDK monetizationNetwork = getMonetizationNetwork();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void setPreinstallAttribution(java.lang.String r4, java.lang.String r5, java.lang.String r6) {
        /*
            r3 = this;
        ...
        L1c:
            ...
            if (r4 == 0) goto L30
            r0.put(r2, r5)     // Catch: org.json.JSONException -> L1a
            goto L35
        L30:
            r0.put(r2, r5)     // Catch: org.json.JSONException -> L1a
            r4 = 0
        ...
        L35:
            ...
            r0.put(r4, r6)     // Catch: org.json.JSONException -> L1a
            goto L4c
        L45:
        ...
        L4c:
            ...
            getMediationNetwork(r4, r5)
            return
        L5c:
            java.lang.String r4 = "Cannot set preinstall attribution data without a media source"
    ...
    public final void validateAndLogInAppPurchase(Context context, String str, String str2, String str3, String str4, String str5, Map<String, String> map) {
        ...
        if (!getMonetizationNetwork().AFInAppEventType().getCurrencyIso4217Code()) {
            ...
            StringBuilder sbJ = z.j("Validate in app called with parameters: ", str3, " ", str4, " ");
            sbJ.append(str5);
            aFLogger.i(aFg1cSDK, sbJ.toString());
        }
    ...
    private static void a(String str, int[] iArr, String str2, int i10, Object[] objArr) throws UnsupportedEncodingException {
        ...
        if (cArr2 != null) {
            ...
            for (int i13 = 0; i13 < length; i13++) {
                cArr3[i13] = (char) (((long) cArr2[i13]) ^ 1825820251896122634L);
            }
            cArr2 = cArr3;
        }
        int i14 = (int) (1825820251896122634L ^ ((long) registerClient));
        if (AFInAppEventType) {
            ...
            while (true) {
                ...
                if (i15 >= i16) {
                    ...
                    cArr4[i15] = (char) (cArr2[bArr[(i16 - 1) - i15] + i10] - i14);
            ...
            while (true) {
                ...
                if (i17 >= i18) {
                    ...
                    cArr5[i17] = (char) (cArr2[cArr[(i18 - 1) - i17] - i10] - i14);
            ...
            while (true) {
                ...
                if (i19 >= i20) {
                    ...
                    cArr6[i19] = (char) (cArr2[iArr[(i20 - 1) - i19] - i10] - i14);
    ...
    /* JADX WARN: Removed duplicated region for block: B:9:0x004c A[PHI: r0
      0x004c: PHI (r0v5 com.appsflyer.PurchaseHandler) = (r0v4 com.appsflyer.PurchaseHandler), (r0v10 com.appsflyer.PurchaseHandler) binds: [B:8:0x004a, B:5:0x0034] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public final void getCurrencyIso4217Code(AFh1mSDK aFh1mSDK, AFh1qSDK aFh1qSDK) throws UnsupportedEncodingException {
    ...
    private void areAllFieldsValid() {
        ...
        try {
            ...
            if (aFi1hSDKAfErrorLog.getCurrencyIso4217Code()) {
                ...
                AFKeystoreWrapper = i10 % 128;
                if (i10 % 2 == 0) {
                    aFi1hSDKAfErrorLog.getMediationNetwork(new AFi1dSDK() { // from class: com.appsflyer.internal.a
                        @Override // com.appsflyer.internal.AFi1dSDK
                        public final void onRequestFinished() {
                            this.f2456a.AFAdRevenueData(aFi1hSDKAfErrorLog);
                        }
                    });
                    return;
                } else {
    ...
    public final void logEvent(Context context, String str, Map<String, Object> map, AppsFlyerRequestListener appsFlyerRequestListener) throws UnsupportedEncodingException {
        ...
        AFd1oSDK aFd1oSDKCopy = getMonetizationNetwork().copy();
        Map map5 = aFh1hSDK.getRevenue;
        if (map5 == null) {
            map5 = new HashMap();
        }
        aFd1oSDKCopy.getRevenue("logEvent", str, new JSONObject(map5).toString());
        if (str == null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x008a, code lost:
        ...
        r5 = com.appsflyer.internal.AFg1cSDK.f2449v;
        r6 = com.appsflyer.internal.AFa1ySDK.getMonetizationNetwork;
        r4.i(r5, "Starting AppsFlyer: (v6.17.6." + r6 + ")");
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void start(android.content.Context r10, java.lang.String r11, final com.appsflyer.attribution.AppsFlyerRequestListener r12) {
        /*
    ...
    */
    ...
    public final Map<String, Object> getMonetizationNetwork(AFh1mSDK aFh1mSDK) throws UnsupportedEncodingException {
        String str;
    ...
    public final void getMediationNetwork(AFh1mSDK aFh1mSDK) throws UnsupportedEncodingException {
        Context context = getMonetizationNetwork().AFInAppEventParameterName().getMonetizationNetwork;
        boolean z5 = true;
        if (context == null) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:16:0x001e A[Catch: all -> 0x0018, TryCatch #1 {all -> 0x0018, blocks: (B:3:0x0001, B:5:0x000d, B:17:0x002b, B:16:0x001e, B:11:0x0017, B:14:0x001a, B:7:0x0011), top: B:24:0x0001, inners: #0 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final synchronized com.appsflyer.internal.AFf1mSDK AFAdRevenueData() {
        /*
            ...
            int r0 = r0 % 2
            if (r0 == 0) goto L1a
            com.appsflyer.internal.AFf1mSDK r0 = r3.equals     // Catch: java.lang.Throwable -> L18
            r2 = 9
            int r2 = r2 / 0
            if (r0 != 0) goto L2b
            goto L1e
        ...
        L1a:
            ...
            if (r0 != 0) goto L2b
        L1e:
            com.appsflyer.internal.c r0 = new com.appsflyer.internal.c     // Catch: java.lang.Throwable -> L18
            r0.<init>(r3)     // Catch: java.lang.Throwable -> L18
            r3.equals = r0     // Catch: java.lang.Throwable -> L18
            int r1 = r1 + 81
            int r1 = r1 % 128
            com.appsflyer.internal.AFa1ySDK.i = r1     // Catch: java.lang.Throwable -> L18
        L2b:
            com.appsflyer.internal.AFf1mSDK r0 = r3.equals     // Catch: java.lang.Throwable -> L18
            monitor-exit(r3)
            return r0
    ...
    private static void AFAdRevenueData(JSONObject jSONObject) {
        ...
        while (true) {
            ...
            try {
                ...
                AFLogger.afErrorLogForExcManagerOnly("error at timeStampArr", e3);
            }
        }
    ...
    private boolean component4() {
        ...
        if (this.component3 > 0) {
            ...
            if (jCurrentTimeMillis < this.component4 && !isStopped()) {
                ...
                StringBuilder sbJ = z.j("Last Launch attempt: ", monetizationNetwork, ";\nLast successful Launch event: ", monetizationNetwork2, ";\nThis launch is blocked: ");
                sbJ.append(jCurrentTimeMillis);
                sbJ.append(" ms < ");
                sbJ.append(j10);
                sbJ.append(" ms");
                AFLogger.afInfoLog(sbJ.toString());
                return true;
            }
            if (isStopped()) {
                return false;
            }
            StringBuilder sbJ2 = z.j("Last Launch attempt: ", monetizationNetwork, ";\nLast successful Launch event: ", monetizationNetwork2, ";\nSending launch (+");
            sbJ2.append(jCurrentTimeMillis);
            sbJ2.append(" ms)");
            AFLogger.afInfoLog(sbJ2.toString());
            return false;
        }
        if (isStopped()) {
            return false;
    ...
    public class AFa1zSDK implements AFe1qSDK {
        ...
        public final void getRevenue(AFe1mSDK<?> aFe1mSDK, AFe1uSDK aFe1uSDK) {
            ...
            if (aFh1pSDKAfWarnLog != null && z5) {
                aFh1pSDKAfWarnLog.getMonetizationNetwork((AFf1rSDK) aFe1mSDK, new d(0, this));
            }
    ...
    private static /* synthetic */ Object AFAdRevenueData(Object[] objArr) {
        ...
        aFa1ySDK.setLogLevel(zBooleanValue ? AFLogger.LogLevel.DEBUG : AFLogger.LogLevel.NONE);
        AFKeystoreWrapper = (i + 117) % 128;
        return null;
    }
    ...
    public static Map<String, Object> getMediationNetwork(Map<String, Object> map) {
        ...
        HashMap map3 = new HashMap();
        map.put(Mechanism.JsonKeys.META, map3);
        return map3;
    }

    private void AFAdRevenueData(String str) {
        AFh1mSDK aFh1mSDKAFAdRevenueData = new AFh1nSDK().AFAdRevenueData(getMonetizationNetwork().AFAdRevenueData().getMediationNetwork.getRevenue("appsFlyerCount", 0));
        ...
        AFKeystoreWrapper = i10 % 128;
        if (i10 % 2 == 0) {
            AFj1aSDK.getCurrencyIso4217Code(getMonetizationNetwork().getMediationNetwork(), new f(1, this, aFh1mSDKAFAdRevenueData), 5L, TimeUnit.MILLISECONDS);
            i = (AFKeystoreWrapper + 21) % 128;
        } else {
            AFj1aSDK.getCurrencyIso4217Code(getMonetizationNetwork().getMediationNetwork(), new f(1, this, aFh1mSDKAFAdRevenueData), 5L, TimeUnit.MILLISECONDS);
            throw null;
    ...
    public static boolean getRevenue(Context context) {
        ...
        try {
            ...
            AFLogger.INSTANCE.e(AFg1cSDK.GENERAL, "WARNING:  Google Play Services is unavailable. ", e3);
            return false;
        }
    }

...
public final class AFe1bSDK extends AFe1mSDK<Boolean> {
    ...
    public final long AFAdRevenueData() {
        return TransactionOptions.DEFAULT_DEADLINE_TIMEOUT_AUTO_TRANSACTION;
    }
    ...
    public final AFe1uSDK getRevenue() {
        for (AFc1uSDK aFc1uSDK : this.areAllFieldsValid.getCurrencyIso4217Code()) {
            ...
            try {
                ...
                AFLogger.INSTANCE.e(AFg1cSDK.QUEUE, "Failed to resend cached request", e3);
            }
        }
    ...
    private static String getRevenue(AFc1uSDK aFc1uSDK) {
        ...
        long j10 = Long.parseLong(aFc1uSDK.getMediationNetwork, 10);
        String str = aFc1uSDK.getRevenue;
        try {
            return Uri.parse(str).buildUpon().appendQueryParameter("isCachedRequest", "true").appendQueryParameter("timeincache", String.valueOf((jCurrentTimeMillis - j10) / 1000)).toString();
        } catch (Exception e3) {

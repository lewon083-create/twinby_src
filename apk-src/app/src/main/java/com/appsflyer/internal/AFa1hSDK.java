...
public class AFa1hSDK {
    ...
    public static final Map f2437d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static Object f2438e;
    private static long force;
    private static Object i;
    private static byte[] unregisterClient;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    private static long f2439v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    private static byte[] f2440w;

    /* JADX WARN: Removed duplicated region for block: B:11:0x002c  */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0032  */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:13:0x0032 -> B:14:0x003b). Please report as a decompilation issue!!! */
    /*
    ...
    */
    ...
    static {
        /*
            Method dump skipped, instruction units count: 7500
    ...
    public static int getMonetizationNetwork(int i10) throws Throwable {
        int i11 = $10 + 85;
        int i12 = i11 % 128;
        $11 = i12;
        if (i11 % 2 == 0) {
        ...
        try {
            ...
            byte[] bArr = $$a;
            return ((Integer) Class.forName($$c(bArr[511], bArr[107], (short) 583), true, (ClassLoader) f2438e).getMethod($$c(bArr[72], bArr[4], bArr[7]), Integer.TYPE).invoke(obj, objArr)).intValue();
        } catch (Throwable th2) {
    ...
    public static int getRevenue(Object obj) throws Throwable {
        ...
        try {
            byte[] bArr = $$a;
            int iIntValue = ((Integer) Class.forName($$c(bArr[511], bArr[107], (short) 583), true, (ClassLoader) f2438e).getMethod($$c(bArr[12], bArr[85], (short) 551), Object.class).invoke(obj2, obj)).intValue();
            int i11 = $10 + 103;
            $11 = i11 % 128;
            if (i11 % 2 != 0) {
                return iIntValue;
    ...
    public static Object getRevenue(int i10, char c8, int i11) throws Throwable {
        int i12 = $10;
        ...
        $10 = (i14 + 43) % 128;
        try {
            Object[] objArr = {Integer.valueOf(i10), Character.valueOf(c8), Integer.valueOf(i11)};
            byte[] bArr = $$a;
            Class<?> cls = Class.forName($$c(bArr[511], bArr[107], (short) 583), true, (ClassLoader) f2438e);
            byte b2 = bArr[14];
            String str$$c = $$c(b2, bArr[4], b2);

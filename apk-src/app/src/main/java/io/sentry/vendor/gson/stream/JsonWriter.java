...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i, int i10, char c8) throws IOException {
        int iPeek = peek();
        if (iPeek != i10 && iPeek != i) {
            throw new IllegalStateException("Nesting problem.");
        }
    ...
    private JsonWriter open(int i, char c8) throws IOException {
        beforeValue();
        push(i);
        this.out.write(c8);
        return this;
    ...
    */
    ...
    public JsonWriter jsonValue(@Nullable String str) throws IOException {
        if (str == null) {
            return nullValue();
        }
        writeDeferredName();

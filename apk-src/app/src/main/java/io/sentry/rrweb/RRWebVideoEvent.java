...
public final class RRWebVideoEvent extends RRWebEvent implements JsonUnknown, JsonSerializable {
    ...
    public static final class Deserializer implements JsonDeserializer<RRWebVideoEvent> {
        private void deserializeData(@NotNull RRWebVideoEvent rRWebVideoEvent, @NotNull ObjectReader objectReader, @NotNull ILogger iLogger) {
        ...
        private void deserializePayload(@NotNull RRWebVideoEvent rRWebVideoEvent, @NotNull ObjectReader objectReader, @NotNull ILogger iLogger) {
            objectReader.beginObject();
            ConcurrentHashMap concurrentHashMap = null;
            while (objectReader.peek() == JsonToken.NAME) {
                String strNextName = objectReader.nextName();
        ...
        @NotNull
        public RRWebVideoEvent deserialize(@NotNull ObjectReader objectReader, @NotNull ILogger iLogger) {
            objectReader.beginObject();

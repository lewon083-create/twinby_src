...
@Metadata
public final class WindowSpy$windowField$2 extends r implements Function0<Field> {
    ...
    public final Field invoke() {
        ...
        try {
            ...
            Log.d("WindowSpy", "Unexpected exception retrieving " + decorViewClass + "#mWindow on API " + Build.VERSION.SDK_INT, e3);
            return null;
        }
    }
}

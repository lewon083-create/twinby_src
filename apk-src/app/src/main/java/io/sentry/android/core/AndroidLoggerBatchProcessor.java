...
public final class AndroidLoggerBatchProcessor extends LoggerBatchProcessor implements AppState.AppStateListener {
    public AndroidLoggerBatchProcessor(@NotNull SentryOptions sentryOptions, @NotNull ISentryClient iSentryClient) {
    ...
    public void onBackground() {
        try {
            ...
            this.options.getLogger().log(SentryLevel.ERROR, th2, "Failed to submit log flush in onBackground()", new Object[0]);
        }
    }

...
public final class SessionReplayOptionsKt {
    ...
    public static final void setMaskAllImages(@NotNull SentryReplayOptions sentryReplayOptions, boolean z5) {
        Intrinsics.checkNotNullParameter(sentryReplayOptions, "<this>");
        sentryReplayOptions.setMaskAllImages(z5);
    }

    public static final void setMaskAllText(@NotNull SentryReplayOptions sentryReplayOptions, boolean z5) {
        Intrinsics.checkNotNullParameter(sentryReplayOptions, "<this>");
        sentryReplayOptions.setMaskAllText(z5);
    }
}

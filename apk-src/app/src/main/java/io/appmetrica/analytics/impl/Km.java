...
public final class Km extends Qm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Lf("preload_info_data", iBinaryDataHelper, new B8(c0211hf, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new C0133ef());
    }
}

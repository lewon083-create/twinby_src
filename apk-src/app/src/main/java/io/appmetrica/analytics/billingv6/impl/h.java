...
public final class h extends r implements Function0 {
    ...
    public final /* synthetic */ Map f21626b;
    ...
    public final Object invoke() {
        Map map = this.f21625a;
        Map map2 = this.f21626b;
        i iVar = this.f21627c;
        m.a(map, map2, iVar.f21631d, iVar.f21630c.getBillingInfoManager());
        return Unit.f27471a;
    }
}

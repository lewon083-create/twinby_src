...
public final class Lm extends Qm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Lf("clids_info", iBinaryDataHelper, new B8(c0649z3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new C0524u3());
    }
}

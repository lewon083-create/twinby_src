...
public final class Im extends Qm {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new Lf("startup_state", iBinaryDataHelper, new B8(c0593wm, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new C0166fm());
    }

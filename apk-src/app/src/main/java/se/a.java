...
public final class a implements b, o {
    ...
    public final void onAttachedToEngine(ei.a flutterPluginBinding) {
        ...
        q qVar = new q(flutterPluginBinding.f16383c, "com.littlegnal.http_proxy_override");
        this.f32904b = qVar;
        qVar.b(this);
    }
    ...
    public final void onMethodCall(n call, p result) {
        ...
        if (str.equals("getProxyHost")) {
            ((g) result).success(System.getProperty("http.proxyHost"));
        } else if (!str.equals("getProxyPort")) {
            ((g) result).a();
        } else {
            ((g) result).success(System.getProperty("http.proxyPort"));
        }
    }
}
